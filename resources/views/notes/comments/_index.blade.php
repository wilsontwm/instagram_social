        ...
        <div class="box">
            ...
            <div class="box-body">
                <div class="comment-form-container margin-bottom">
                    {!! Form::open(['route' => ['notes.comments.store', $note->id], 'class' => 'form-horizontal']) !!}
                ...
                <div class="comment-section">
                    @foreach($note->comments()->whereNull('reply_id')->get() as $comment)
                                ...
                                <div class="">
                                    <div class="username">
                                        ...
                                        <ul class="main-post-tools box-tools list-inline pull-right">
                                            ...
                                            <li>
                                            {!! Form::open(['route' => ['notes.comments.delete', $note->id, $comment->id], 'class' => 'form-horizontal']) !!}
                                    ...
                                    <div class="">
                                        <div class="username">
                                            ...
                                            <ul class="sub-post-tools box-tools list-inline pull-right">
                                                ...
                                                <li>
                                                    {!! Form::open(['route' => ['notes.comments.delete', $note->id, $reply->id], 'class' => 'form-horizontal']) !!}
                                                    <button type="submit" class="btn btn-box-tool"><i class="fa fa-times"></i></button>
                                                    {!! Form::close() !!}
                                                </li>
                                                @endif
    ...
    $(document).ready(function(){
        ...
        $('.btn-reply').click(function() {
            ...
            replyBox =  '<div class="reply-comment-form-container margin-bottom col-xs-offset-2 col-xs-10 col-sm-offset-1 col-sm-11 col-md-offset-1 col-md-11">'
                + '{!! Form::open(["route" => ["notes.comments.store", $note->id], "class" => "comment-reply-form"]) !!}'
