            ...
            <div class="col-md-9">
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">My sent gifts</h3>
                    </div>
                    <div class="box-body no-padding">
                        @if($gifts->count() == 0)
                        <div class="text-center">
                            <h1><i class="fa fa-frown-o text-maroon"></i></h1>
                            <h4>You have not sent any gifts yet</h4>
                        </div>
                        @endif
                                ...
                                <div class="">
                                    <a href="{{ route('gifts.show', $gift->id) }}" style="color:inherit">
                                        <div class="notification-img">
                                            <img src="{!! $gift->getReceiverProfileImageUrl() !!}" />
                                        </div>
                                        <div class="notification-content">
                                            You have sent <strong>{!! $gift->getReceiver() !!}</strong>  a {!! $gift->gift->title !!} <br />
